...
public class LinkedListDeque61BTest {
    ...
    @Test
    /**this test is for testing isEmpty and size. */
    ...
    @Test
    /**this is for testing get method. */
    public void getTest(){
        Deque61B<Integer> lld1 = new LinkedListDeque61B<>();
    ...
    @Test
    /**this is for testing getRecursive method. */
    ...
    @Test
    /**this is for testing removeFirstAndremoveLastTest method. */
    public void removeFirstAndremoveLastTest(){
        ...
        assertThat(lld1.removeFirst()).isEqualTo(-1);//[0,1]
        assertThat(lld1.size()).isEqualTo(2);
        assertThat(lld1.removeLast()).isEqualTo(1);//[0]
